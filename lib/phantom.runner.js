var phantom = phantom || {},
	...
	var jasmineCoreRoot = utils.joinPath(fs.workingDirectory, "/node_modules/jasmine-core/lib/jasmine-core");
	var jasmineReportersRoot = utils.joinPath(fs.workingDirectory, "/node_modules/jasmine-reporters/src");
	var jasmineSources = [jasmineCoreRoot + "/jasmine.js", 
...
pipelineExecutor.push("Waiting for jasmine to finish", function(){
	...
	utils.waitfor(function() {
		return page.evaluate(function() {
			...
			logger.log("Jasmine timed out. Stopping...", true);
			waitForExternalExecution = false;
		}, -1);
});
